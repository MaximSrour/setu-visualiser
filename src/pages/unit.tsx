    ...
    <>
      ...
      <main className="flex min-h-screen flex-col items-center justify-center">
        <div className="flex w-full flex-col items-center justify-center gap-12 px-4 py-16">
          ...
          <h1 className="text-center text-3xl">{selectedUnit} results</h1>
          ...
          <div className="flex w-full flex-col items-center justify-center gap-8">
            <h2 className="text-center text-2xl">University-wide Aspects</h2>
          ...
          <div className="flex w-full flex-col items-center justify-center gap-8">
            <h2 className="text-center text-2xl">Faculty-wide Aspects</h2>
